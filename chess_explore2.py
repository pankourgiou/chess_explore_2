...
background = pygame.image.load("chess_explore_2.png")  # Make sure you have an image file
...
locations = [
    {"name": "A", "event": "every day we start from zero, every day flows difficultly, this must change.", "x": 350, "y": 450},
    {"name": "B", "event": "a warrior must flow like water", "x": 450, "y": 500},
    {"name": "C", "event": "will iron dome help?", "x": 380, "y": 280},
